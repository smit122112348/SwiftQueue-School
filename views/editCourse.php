        ...
        <div class="w-2/3 p-5 bg-slate-200 rounded-md shadow-lg">
            ...
            <form action="/editCourse" method="POST" class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <textarea name="course-description" id="description" class="p-2 rounded-md border border-gray-300"><?php if (isset($course['course_description'])) echo htmlspecialchars($course['course_description']); ?></textarea>
                </div>
